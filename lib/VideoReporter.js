...
VideoReporter.prototype.specDone = function(result) {
  ...
  if (!self.options.singleVideo) {
    ...
    switch (result.status) {
      case 'passed':
        text += '<font size="6" color="#31D57C">SUCCESS</font>';
        break;
      case 'failed':
        text += '<font size="6" color="red">FAILED</font>';
        break;
      case 'pending':
        text += '<font size="6" color="yellow">PENDING</font>';
        break;
    }
    text += ' <font size="6">' + result.description + '</font>';
